...
are due to some journals changing titles at least once.\footnote{To
  ...
  discipline labels and are excluded from tabulations.} The JSTOR coding
contains 79 subject labels. These labels refer to eight superdisciplines
under which may be found 71 disciplines.
...
labels is two, which is the median case accounting for 53.6 percent of
...
network we have 34 times as many journals as labels and each journal
...
larger components. In the sampled network the journal facet is seven
...
journal and label facets are comparable, 26.3 and 27.2 percent
