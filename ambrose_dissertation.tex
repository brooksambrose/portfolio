...
\hypertarget{preface-on-computational-reproducibility}{%
\section*{Preface on Computational
Reproducibility}\label{preface-on-computational-reproducibility}}


This study attempts to conduct a conventional sociological research
project in an unconventional way. Computational social science is
normally understood to leverage statistical methods that require greater
computing resources in memory or processing speed than tend to be
available on personal computers or workstations. It also
...
life was reconstituted. Drawing on economic historians Zucker has shown
that in the period
