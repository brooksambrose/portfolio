...
while at the 90th percentile the rate is 27 in 1,000. 46 texts (0.73
...
{\centering \includegraphics{ambrose_dissertation_files/figure-latex/unnamed-chunk-8-1} 

}

\caption{Sankey diagram of document overlap between topic models of increasing values of K.}\label{fig:unnamed-chunk-8}
\end{figure}
...
{\centering \includegraphics{ambrose_dissertation_files/figure-latex/elbow-1} 

}

\caption{Cumulative distribution of within topic term probabilities.}\label{fig:elbow}
\end{figure}
