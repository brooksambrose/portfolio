...
larger components. In the sampled network the journal facet is 11 times
...
Are culturally interior artifacts referenced by socially superior
scholars?
...
large continents to small isles. These regions are either showlowly
connected or totally separated from each other. The vast majority of
...
The most substantial flat isle comes from four authors publishing in the
same 1930 \href{https://www.jstor.org/stable/i40084238}{issue} of
...
The structure of the group is provided by an article by Robert Reisch ;
the other three shared no references in common and Reisch's article,
titled ``The `Deposit'-Myth In Banking Theory'' and containing 108
references, is likely to have been written as an introduction to the
journal on the basis of what had already been accepted for publication.
Indeed another flat isle of four articles has the exact same pattern,
also from \emph{Zeitschrift Fur Nationalokonomie} but from an
...
Introduction'' and containing 25 references, includes subsections of the
bibliographies of three other articles that do not themselves overlap.
...
Reviews, whether they are formally labeled as such, borrow directly from
...
{\centering \includegraphics[width=9.72in]{img/k3c1-22} 
