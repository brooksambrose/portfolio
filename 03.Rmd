...
```{r worstterms,include=T,fig.cap=sprintf('Terms from %s that are expected to derive from topic 2',whwh(wst))}
...
```{r sumrnk,include=T}
sg(data.table(Rank=knar,krank[,!'r'] %>% setcolorder(ec('ktl,cut,ghst,res,pltp,altp,m300,gini,conf,ldp')),srank[.N:1] %>% setnames(ec('Sum.,Mean,Variance'))),tit='Summary of Diagnostic Ranks')
```
