...
```{r kcc2tree, fig.cap='K-clique Community Structure.',fig.cap='K-clique Community Structure. [*Interactive pop-out.*](exh/kcc2tree.html){target="_blank"}',eval=T,include=T, message=FALSE, warning=FALSE}
...
```{r kcc2isl,fig.cap='K-clique Community Island Plot. [*Interactive pop-out.*](exh/isl3d.html){target="_blank"}',include=T,eval=T,cache=T}
f<-'d/b/kcc2isl.RData'
if(file.exists(f)){
  load(f)
