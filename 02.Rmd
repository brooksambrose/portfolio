...
rm(f)
plt(jnet,tooltip='text')
```

Social science journals are overrepresented due to JSTOR's initial focus in that area. The journals within social science cover `r jclu$tab %>% length %>% nn` different subdisciplines.
