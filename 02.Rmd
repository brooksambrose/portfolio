...
Lizardo operationalizes genre preference data in network terms by "inducing a network of persons connected to the cultural genres they choose" [-@Lizardo2018mutual\:53], which allows him to analyze individual preferences within global contexts revealed in bimodal network patterns.

Multimodal networks are an analytical convention where there are at least two classes of items that bear relations and in which a rule is imposed that such items may only be related to items of a different class. Insofar as the researcher cares about intraclass relationships she must understand them as mediated by one of the alternative classes. The simplest multimodal network has two classes (see [@Shi2015Weaving] for examples of many more).
